...
class BotConfigView(tkinter.Frame):
    def __init__(self, master=None):
        ...
        self.interval_entry = tkinter.Entry(bot_configuration_container)
        ...
        self.nb_categories_entry = tkinter.Entry(bot_configuration_container)
        ...
        self.learning_rate_entry = tkinter.Entry(bot_configuration_container)
        ...
        self.discount_factor_entry = tkinter.Entry(bot_configuration_container)
        ...
        self.iteration_entry = tkinter.Entry(bot_configuration_container)
